...
router.get(
  "/getSecretaryByMedcineName/:loginMedcine",
  MedcineController.getSecretaryByMedcineName
);
router.get(
  "/searchMedcine/:speciality",
  MedcineController.getMedcineBySpeciality
);
router.get(
  "/getOrdonnanceByMedcine/:id",
  MedcineController.getOrdonnanceByMedcine
);
router.get(
  "/getOrdonnanceByPatient/:id",
  MedcineController.getOrdonnanceByPatient
);
// router.put('/activateCompte/:token', MedcineController.activateCompteMedcine);
router.put(
  "/updateAvailabilityMedicine/:id",
  MedcineController.UpdateAvailabilityMedicine
);
router.put(
  "/manageSecretaryAccount/:id",
  MedcineController.ManageSecretaryAccount
);
...
router.post(
  "/forgot-password",
  resetLimiter, // Apply rate limiting
  MedcineController.forgotPassword
);

router.post(
  "/reset-password/:token", // Token in URL (more secure)
  resetLimiter,

  MedcineController.resetPassword
);
